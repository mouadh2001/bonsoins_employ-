    ...
    <ScrollView contentContainerStyle={styles.container}>  
        ...
        <View style={styles.containeractualite}>
            ...
            <View style={styles.textholder}>
                <Text style={styles.title}> Toutes les communications liées au travail en un seul endroit</Text>
                <Text style={styles.actualitetext}>le fil d'actualité permet à votre gestionnaire d’horaire de partager diverses annonces et documents importants. il n'y a pas de publications pour le moment</Text>
            </View>
        </View>
    </ScrollView>
  );
