...
import ConversationScreen from '../Component/ConversationScreen';
import MessagingScreen from '../Component/MessagingScreen';

function MessangerScreen({ navigation }) {
    return (

<ScrollView contentContainerStyle={styles.container}>
<View style={styles.container}>
  <View style={styles.body}>
      <ConversationScreen style={styles.left}/>
      <MessagingScreen style={styles.right} />
  </View>
  <View style={styles.navebar}>
    ...
    <Pressable style={styles.thisbutton} onPress={() => navigation.navigate('Messanger')}>
